...
9. Mint one ticket per class once the owner reads the report, and name it under the class's tickets. A ticket minted before the read carries a fix the owner has yet to weigh. *
