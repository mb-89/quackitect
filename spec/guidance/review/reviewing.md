...
1. Ask whether the branch does what the group's ask calls for, and name what goes missing. *
2. Ask whether everything the diff touches beyond the ask is a trivial fix. *
...
7. Count a file outside the ask as a fault only where it redesigns what the ask leaves alone. *
