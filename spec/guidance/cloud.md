...
6. Answer a question whose wrong answer a later commit undoes. Hand out one that spends, sends, or loses work nobody rebuilds. *
...
9. Finish every step an agent takes. A step stamped `by: person` is a question, so weigh a wrong answer before handing it out. *
