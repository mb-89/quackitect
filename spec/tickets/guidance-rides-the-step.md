...
record:
  ...
  - step: children
    ...
    hash_before: b2b44a53f73c1330f87e3b212eef3a23463649fc
  - step: children
    hand: box 7ba446c2fed1 · claude-code-remote
    skipped: true
    why: the box leaves it while the-pull-splits-by-topic stand open
  - step: retro/notes
    hand: box 7ba446c2fed1 · claude-code-remote
    hash_before: 1cdcbe5052787614e126afcb965adbc817ec9583
    hash_after: 1cdcbe5052787614e126afcb965adbc817ec9583
    answered:
      - name: drained
        exit: 0
        said: .se/tickets holds no open note, so the box leaves nothing behind.
  ...
  - step: children
    hand: the engine
    hash_before: 9fda0f3308002977a473a06dba968ed4145759e8
    hash_after: 9fda0f3308002977a473a06dba968ed4145759e8
  - step: retro/notes
    hand: box d5700e16c529 · claude-code-remote
    hash_before: 06da480542025b35562a6e3d9c0b9b6fed88cae3
    hash_after: 06da480542025b35562a6e3d9c0b9b6fed88cae3
    answered:
      - name: drained
        exit: 0
        said: .se/tickets holds no open note, so the box leaves nothing behind.
