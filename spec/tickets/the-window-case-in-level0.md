...
the draft puts the new-window case in `test/extension/session.test.js`, and the Ask asks for a case under `test/level0`. The builder puts it in `test/level0/session-layer.test.js` or beside `test/level0/binding.test.js`
