...
Does the sidebar slice switch over? The owner answers this, once its shadow runs clean for as long as the owner judges enough. A box answers none of it. [[spec/design_output/work#the-owner-opens-the-gate]] names the commands.

- [[spec/tickets/sidebar-switches-over]] and every child of it wait for this ticket to close
