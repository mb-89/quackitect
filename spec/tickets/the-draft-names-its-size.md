...
the draft carries no `size`, and the ask leaves out `src/scripts/pull-hand.js`, `src/scripts/pull-writes.js`, `test/contract/process.test.js` and `test/contract/question-grades.test.js`
