...
This ticket answers both questions in [[spec/funnel/the-inner-protocol-stands-open]]. One is the protocol between the index and its processes, and the other is how the editor reaches the LSP door.
