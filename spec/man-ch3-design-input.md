...
-->
<!-- ai:3 -->
How the rows interconnect lives in one place: the [trace](term:trace), one page per need, in the [overview chapter](man-sys-overview.md). The register below is the flat index over every input type:
