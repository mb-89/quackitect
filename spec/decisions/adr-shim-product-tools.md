...
statement: The go-bin fallback shim ships ONCE in the repo at product/tools/go.cmd; the dogfood launcher appends product\tools to PATH, scaffolded vehicle/stub launchers append tools\vendor\tools - so the documented uv/go-bin lane works for bootstrap AND the engine's internal ratchet rebuild on machines without native Go.
class: review
killer: false
---
