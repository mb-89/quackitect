...
|2| verification | `battery` | the engine's own execution of the command declared on this row (`npm --prefix deliverable test`): the captured run and its exit code, across all iterations |
