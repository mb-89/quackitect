...
A token is a markdown note. Its frontmatter is what the engine reads. Its body is prose. A token lives under .se/work when it is private, and under spec/work when it travels. The minter decides which, and nothing moves it afterwards.
