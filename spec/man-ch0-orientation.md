...
-->
<!-- ai:3 -->
Quackitect is a user-driven gate [ledger](term:ledger): AI agents do the work, people adjudicate the [gates](term:gate), and a deterministic [engine](term:engine) keeps the record honest. This document is that record, compiled into a book. It serves every stakeholder of the project. Nobody reads all of it - pick your view below and stop when you have enough.
---
fig: context-star
---
