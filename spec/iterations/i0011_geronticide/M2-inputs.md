...
**Verify:** 9/9 statements EARS-shaped, each naming its checkable outcome; the two coverage checks compute green. **Validate:** the set covers M1's four success outcomes exactly — parity/suspect/pager under honest-board, hashing/cap under verdict-integrity, the stamp under user-wording, markers/decisions/lanes under no-grandfathers. **Red-team:** weakest statement probed — req-grandfathers-decided could be satisfied by rubber-stamp ADRs; bounded: the L3 gate reviews the decisions' substance, and the test fails on any exemption without one. **Verdict: PASS.**
