# M8 - Handover (i0012_spec_book, systematic)

TL;DR: the spec book ships committed beside its sources with the drift lint armed and green. The durable product:

- the template set
- the item model
- the shell

The reader starts at spec/book.html. The agent starts at AGENTS.md. Both are emitted from the same truth.

## Docs complete & matching  -> i12-m8-docs-complete
...
## Packaged & versioned  -> i12-m8-packaged
...
## Configuration baselined  -> i12-m8-config-baselined
...
## Handover accepted  -> i12-m8-handover
