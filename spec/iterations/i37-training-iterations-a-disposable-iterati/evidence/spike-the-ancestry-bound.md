---
form: spike-the-ancestry-bound
by: agent
signed_off: 2026-08-19T20:19:46.456Z
reopened: 2026-08-19T20:19:46.224Z — rank-unknowns re-signed above the sub-machine, so every spike claim is re-stamped against the same ground
authors: agent
files: null
---

# Evidence form / spike-the-ancestry-bound

## current_situation

spike-the-ancestry-bound, re-signed after rank-unknowns re-signed above the sub-machine.

The measurement is unchanged and so is the verdict. The re-sign asserts that the moved ground did not move this answer.

## built

- [[exp-does-an-ancestry-test-fit-inside-the-one-millisecond-bound]]
