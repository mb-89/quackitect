# M8 — Package & hand over (i0010_engine_workshop)

## Docs complete & match the surface  → i10-m8-docs-complete

- [AGENTS.md](../../../AGENTS.md): command list carries `notes`, the enforcing `observe-red` wording, the stamp-writing `build`. The ritual chain stands.
- Usage text (`quack -h`): includes `notes [--all]`.
- [dependencies.md](../../../product/quackitect/method/prompts/dependencies.md): build description names the stamp.
- [engage.md](../../../product/quackitect/method/prompts/engage.md) + [compose-reference.md](../../../product/quackitect/method/prompts/compose-reference.md): the order-is-not-dependency rule and the combined hand-off are the documented method.
- [review.md](../../../product/quackitect/method/prompts/review.md): retro step 6 aggregates then deletes calls.jsonl.
...
## Handover accepted  → i10-m8-handover-accepted
