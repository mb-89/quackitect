# M8 — package & hand over (i0013_comments)

## Docs complete & match the actual surface → i13-m8-docs-complete
...
- **The agent guide matches the grown surface**: `note --file2list`, `observe-red --refresh`, `calls --summary`, and the build fast-path note added to the command table in [man-agent-guide.md](../../man-agent-guide.md); the repo AGENTS.md re-emits from it at ship.
...
## Packaged & versioned → i13-m8-packaged
...
## Configuration baselined → i13-m8-config-baselined
...
## Handover accepted → i13-m8-handover
