...
- **Verify** — docs match the shipped surface. Build + golden baselined. Selftests green.
- **Validate** — the iteration delivers `uc-drive-from-inside` end to end.
- **Red-team** — the one process scar (the freeze) is fixed and guarded, and its lesson codified in the method.
- **Pass** → gate blessed.
