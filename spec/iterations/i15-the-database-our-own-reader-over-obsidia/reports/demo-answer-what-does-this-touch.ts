...
// Run as: node spec/iterations/i15-the-database-our-own-reader-over-obsidia/reports/demo-answer-what-does-this-touch.ts
...
console.log(mine ? `file to read next: spec/decisions/${mine.name}.md` : "no row found");
