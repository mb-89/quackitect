...
node against deliverable/engine/query.ts (answerStructuredQuery),
...
- Fix: deliverable/engine/tables.ts, parseBase
- Regression tests: deliverable/tests/query.test.ts, the two cases
