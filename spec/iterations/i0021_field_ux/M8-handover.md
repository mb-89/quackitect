...
## Configuration baselined  → i21-m8-config
...
- [engage.md](../../../product/quackitect/method/prompts/engage.md): dual-channel
...
- [AGENTS.md](../../../AGENTS.md): `quack verify` on the command surface, the apply-lane
  default, the MCP autostart lane, the visible self-closing window rule.
- [README](../../../README.md): the duplicate keyword footer removed; the public surface
  (description, topics) refreshed on GitHub and ruled by [q-ship-tags](q-ship-tags.md).
...
- The open ship-tags question is a decision node on THIS gate's hand-off:
  [q-ship-tags](q-ship-tags.md) — ruled C, no revision tags. The note's real concern
