...
-->
<!-- ai:3 -->
The structure below opens quack into its parts. The determinizer part is the software; click it to open the layered onion beneath - the onion details exactly that part.
---
fig: model model-quack-structure
---
<!-- ai:3 -->
The layered figure below derives from the design elements and the layer map. It details the determinizer part of the structure above. Enter a layer by clicking it; the breadcrumbs lead back; every leaf links to its trace item. Each interface is a connection with its contract one click away; the forces that shaped the cut render beneath it.

<!-- ai:3 -->
How a cut like this is found with matrix methods lives in its own guide: [structuring a design with matrix methods](guide-structuring-methods).
---
fig: onion
---
![[interfaces.base]]
