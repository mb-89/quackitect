...
- 4b. THE MODEL DOES NOT STAND IN FOR THE PART. `guidance/method/subagents.md` § Which model, owner grant 2026-07-11: judgment work INHERITS the session model. A guide can carry the walker's own model name, and then grouping by model returns one bucket for two hands.
