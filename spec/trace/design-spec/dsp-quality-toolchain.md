...
files:
  - deliverable/engine/testreporters.ts
  - deliverable/engine/tools.ts
  - deliverable/engine/lint.ts
  - deliverable/engine/bin/grades-complete.ts
  - deliverable/engine/bin/backfill-minted.ts
  - deliverable/engine/lintfix.ts
  - deliverable/engine/bin/selftest.ts
  ...
  - deliverable/engine/bin/test-timings.mjs
...
THE PROSE INSPECTION, as much of it as a command can answer (i33, 2026-08-17).
  ...
  node deliverable/engine/bin/prose-inspect.ts [--root <project root>]
...
THE RECORD INSPECTION, the two items a command can answer (i33, 2026-08-17).
  ...
  node deliverable/engine/bin/record-inspect.ts [--root <project root>]
