...
source: TRIZ separation IN TIME, dissolving “the query answers fast” vs “the query answer is reliably current” — the same mechanism already runs in this engine's own corpus loader, deliverable/engine/trace.ts loadTrace() and corpusVersion(), lines 562-588 (passEpoch()/corpusStamp())
---
