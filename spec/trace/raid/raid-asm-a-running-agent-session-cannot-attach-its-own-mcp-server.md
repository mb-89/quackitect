...
probe: "holds on this harness only. i35 on 2026-08-17: the session began with no se_ tools, placing .mcp.json mid-session added none, and the lane became reachable only over HTTP. One host is not a law; the trigger is any harness offering a live attach."
probed: 2026-08-17
source_refs:
...
`.mcp.json` mid-session changed nothing, because the registry was
