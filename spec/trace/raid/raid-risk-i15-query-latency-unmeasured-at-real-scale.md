...
source_refs:
  ...
  - spec/iterations/i15-the-database-our-own-reader-over-obsidia/evidence/evaluate-architecture.md
  - el-query-evaluator
---
...
spec/trace (more than double the ~328 the earlier probe used) —
