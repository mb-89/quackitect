...
type: "[[raid]]"
kind: issue
statement: A write verb's description says nothing about the guards that refuse it, so an author meets SE-C-146, SE-C-154 and SE-C-155 for the first time as a refusal.
