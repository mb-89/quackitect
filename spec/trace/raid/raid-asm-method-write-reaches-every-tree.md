...
dropped. `guidance/refusals.md` states it plainly: shared method
...
A method card under `deliverable/machines/methods/` was patched
...
file tools resolve `...` into the worktree as well.
