...
Restore a zero-failure acceptance baseline by repairing the spill-file fixture path and updating assertions that no longer match the supported transport behavior.

## When it comes back

ready when i36 enters verification
