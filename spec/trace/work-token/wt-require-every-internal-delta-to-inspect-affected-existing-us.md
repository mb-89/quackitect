...
place: M2_20_generalize-use-cases
...
Require every internal delta to inspect affected existing use cases before accepting an empty use-case result.

## When it comes back

ready when iteration design-input guidance or use-case derivation is changed
