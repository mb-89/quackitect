...
Isolate state-machine navigation from the active MCP session so opening a view cannot reset a walk or interrupt server work.

## When it comes back

ready when the state-machine surface or MCP session lifecycle is changed
