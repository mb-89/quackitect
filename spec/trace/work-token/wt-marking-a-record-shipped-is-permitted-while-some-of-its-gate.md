...
Marking a record shipped is permitted while some of its gates are still ungreen, and the mark then puts those gates permanently out of reach.

## When it comes back

ready when the router's handling of a container it has finished is next opened
