---
id: wt-a-hand-sent-to-walk-a-segment-can-find-that-segment-already-
type: "[[work-token]]"
statement: |-
  A hand sent to walk a segment can find that segment already signed by somebody else. It learns this only by opening a form it expected to be blank.

  WHAT IT COST, measured once. One whole authored step was thrown away. Three fields landed on a checkpoint by accident, because the checkpoint happened to carry the same field names.
...
ready when the spawning method or the form refusals are next opened
