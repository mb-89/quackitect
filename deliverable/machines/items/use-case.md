...
Lives in `spec/trace/use-case/`. It is a STANDING ARTIFACT: it outlives
...
clothes, and it belongs downstream instead (see deliverable/machines/items/value-prop.md).
