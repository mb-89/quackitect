...
- behaviour_modelled - the LOOK is owed, never the model.
  ...
  - A model on every row is slop and worse than the gap it closes. The test and the shapes are in [[meth-requirement-authoring]].
