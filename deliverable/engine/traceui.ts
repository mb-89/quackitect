...
export function traceCard(
  ...
  if (props.length === 0) {
    return `<div class="widget" id="w-trace"><div class="widget-head"><span>trace graph</span>${expand}</div><div class="widget-body"><div class="meta" style="padding:10px 12px">no trace nodes yet — the graph draws as spec/trace/ fills</div></div></div>`;
  }
