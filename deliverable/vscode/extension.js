...
async function produceTree(kind, name, dest, abbr) {
  ...
  if (answer.ok !== true) {
    const why = answer.expected ? `Expected ${answer.expected}, got ${answer.got}.` : String(answer.error ?? "the engine refused and said nothing more");
...
var nativeExceptions = /* @__PURE__ */ new Set(["web_search", "WebSearch"]);
