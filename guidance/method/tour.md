---
id: method-tour
statement: The tour - the agent walks a newcomer through the system, generated from the live state, never recited.
---

# the tour — method

Somebody new asks for a tour. The front desk's own statement invites it.
This card holds the ORDER and the emphasis; the CONTENT comes from the
...
- a card id, which is its title from
  `deliverable/views/cards.md`, slugged
...
- The human is never decoration: a gate weighs more than the ordinary
  ...
  in deliverable/machines/scale.md is the one place the weights are written down.
