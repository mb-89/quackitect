...
|||
ONE LIST, EDITED BY HAND, READ LIVE — the same shape both existing dials already use, machines/scale.md and machines/stopat.md, each with its contract stated at the top of the file.
...
|||
THE ASYMMETRY IS THE ONE SAFETY RULE AND IT HAS NO MECHANISM. No field is declared for the reason, no clause covers its absence, and nothing compares the recommendation against what walked. raid-risk-the-weaker-model-asymmetry-has-nothing-enforcing-it, graded crippling.
