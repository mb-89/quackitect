...
precondition: a .base file under the vault declares a view naming its filter, sort and column order; the corpus holds nodes, edges, states and notes as markdown files under project/spec
