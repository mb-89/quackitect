...
source_refs:
  ...
  - "measured on the i15 walk: the contract named machines/stopat.md, the reader passed it to se_file_read verbatim, and two refusals and a glob went by before the file was found at project/deliverable/machines/stopat.md"
