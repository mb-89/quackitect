...
THE MODEL IS NOT A PROXY FOR THE PART. `project/guidance/method/subagents.md` § Which model says judgment work inherits the session model, so a guide can carry the walker's own model name.
