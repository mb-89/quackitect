...
id: raid-risk-many-writers-one-ledger
type: "[[raid]]"
kind: risk
statement: Sideways scale strains the one-ledger promise - many machines writing one product can fork the truth the record promises to keep single.
owner: the driving agent
trigger: two machines land trunk work in the same day, or any merge conflict touches the record store or the trace
status: open
