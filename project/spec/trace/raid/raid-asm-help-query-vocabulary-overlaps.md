...
status: open
probed: "not yet — needs real se_help usage to accumulate"
probe: "unprobed — .se/help-demand.jsonl does not exist yet; se_help has no real usage recorded to spot-check against rankDemand. Re-probe once real query traffic accumulates."
