...
source_refs:
  ...
  - project/spec/trace/requirement/req-repeated-failure-shape-becomes-durable-work.md
  - project/spec/trace/test-spec/tsp-interrupted-call-names-the-stopping-layer.md
  - project/spec/trace/test-spec/tsp-repeated-failure-shape-becomes-durable-work.md
---

## What is owed

TWO MODULES COMPUTE AN ANSWER AND HAND IT TO NOBODY. A search for their
exported functions across `project/deliverable/**` finds the module and its
