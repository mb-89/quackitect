...
id: raid-flip-living-form-on-walk-survives-host-swap
type: "[[raid]]"
kind: risk
statement: The convergence flips — cand-living-form passes cand-thin-worktree if req-walk-survives-host-swap moves by one point, and that story was ruled credible.
...
Re-run the convergence with req-walk-survives-host-swap moved one point toward cand-living-form.
