...
by: agent
signed_off: 2026-08-12T21:05:18.508Z
authors: agent
files:
---
...
M3 derive-functions: the tree extends by one child under fn-run-a-governed-walk, for the delta's four requirements.
...
Solution-neutral: "find a capability" and "log a miss" both hold for any implementation — a keyword scorer, an embedding search, a hand-curated index would all satisfy the same function. Nothing in the statement names a technology, a data structure, or a file format.

## follow_up

M4 next — candidate generation and convergence, or its minor-tailored equivalent.
