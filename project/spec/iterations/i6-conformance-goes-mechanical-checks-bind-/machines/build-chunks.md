...
steps:
  ...
  - id: guard-refuses-a-wrong-word
    ...
    depends_on: [guard-refuses-a-parse-break]
    realization: code
  - id: the-sweep
  ...
  - id: report-versus-refuse
    ...
    depends_on: [guard-refuses-a-wrong-word, the-sweep]
    realization: code
  - id: rules-bind-to-nodes
    ...
    depends_on: [report-versus-refuse]
    realization: code
  - id: an-unbound-rule-is-named
    ...
    depends_on: [rules-bind-to-nodes]
    realization: code
  ...
  - id: dead-branch-code-goes
    ...
    depends_on: [the-cloud-start-reads-trunk]
    realization: code
---
