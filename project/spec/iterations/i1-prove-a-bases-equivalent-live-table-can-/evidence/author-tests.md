...
| [[tsp-hand-walk]] | demonstration | req-autonomy-gates-every-hop | none — the procedure below is the definition; the observed session is the evidence |
...
| [[tsp-reading-proof-run]] | demonstration | req-reading-proof · req-compaction-reowes-the-reading · req-owed-reading-is-served | none — the procedure below is the definition; the observed session is the evidence |
