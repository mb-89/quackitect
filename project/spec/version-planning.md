...
whole at `project/V2-INVENTORY.md`.
...
MOST OF IT ALREADY EXISTS. `project/spec/references/` holds 25 files carrying
...
THE FOLDER ALREADY EXISTS AND WE BUILT IT. `project/guidance/` is projected into
...
`project/scratchpad/ASD-STE100_ISSUE9.pdf`. The lane cannot read it — 3.3MB of
