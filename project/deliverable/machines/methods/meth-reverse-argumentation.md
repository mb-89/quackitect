---
kind: method
statement: "Reverse argumentation: argue the opposing case in full, and find the first credible world where the favourite loses."
---

# Reverse argumentation — attack the idea before adopting it

**What.** Argue the OPPOSITE with full force: why this idea fails, why
the problem should not be solved, why the current state is right. The
premortem's cousin — v1 field precedent.

**When.** One idea is about to win by charm; the room (or the agent)
