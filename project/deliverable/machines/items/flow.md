...
artifact: node
id_prefix: flow-
folder: project/spec/trace/flow
applies_rigor:
  - systematic
applies_type:
  - default
...
Lives in `project/spec/trace/flow/`.
...
The check is `project/deliverable/engine/bin/flow-closure.ts`, and it runs as derive-functions'
exit script.
