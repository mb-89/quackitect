...
This is the same shape the repo already uses twice. `project/deliverable/machines/scale.md` holds
the autonomy rungs as a list, and `project/deliverable/machines/lint/voice-lint.md` holds the lint
thresholds.
...
- `rungs` — a bank of cumulative switches. Fields: source.
  The source names where the rungs come from; `scale` is project/deliverable/machines/scale.md and
  `stopat` is project/deliverable/machines/stopat.md.
...
THE NOTCHES ARE project/deliverable/machines/stopat.md, which holds what each one means and why the
