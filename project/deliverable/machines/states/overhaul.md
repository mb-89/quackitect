...
guidance: |
  OVERHAUL, applied. Follow `project/guidance/method/overhaul.md` step by
  step.
  ...
  Open with se_survey and the full suite. Then sweep the system against the
  RULES THAT CHANGED since the last overhaul. Never against everything, or the
  ...
  Deletion is the owner's word, never yours.

  Pull onward when the sweep is closed and every ruling is executed or noted.
---
