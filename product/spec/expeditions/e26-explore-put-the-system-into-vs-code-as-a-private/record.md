...
### What this expedition actually holds

The goal above describes the VS Code plugin. The bundle grew past it during
the day. This section is the amendment software.md asks for.

Beyond the plugin, this expedition carries:

- A survey rebuild.
- A voice matrix.
- A rigor-matrix migration across roughly 250 files.
- A mermaid renderer, tried and rejected.
- The MCP output limit, raised for the whole lane.
- The Claude side-bar launch, taught to carry its own kickoff.

Somebody looking for one of those would not have looked here. That is what
bundling costs. Naming them is what keeps the thread.
