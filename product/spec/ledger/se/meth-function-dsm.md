...
## Situation
M4's partition_functions: cluster the function structure BEFORE enumerating candidates - the morphological chart needs the partitioned functions as rows. The matrix is a projection over the function notes' typed edges; nothing is stored separately.
