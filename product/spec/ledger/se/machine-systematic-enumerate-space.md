---
id: se.machine-systematic-enumerate-space
kind: machine_state
...
## Evidence form
- chart | the morphological chart: rows, options, pruned cells with reasons | required
- shortlist | the seeded combinations, one line each | required
