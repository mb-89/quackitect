---
id: se.machine-systematic-draft-vision
kind: machine_state
...
- to_be_world | who does what in the to-be world, alive | required
- goal_system | goals, conflicts named openly, priority order ruled | required
- moore_pitch | all five slots filled | required
