...
- NOT PORTED FROM v1, deliberately: the M4 diagram hard-rule and its boilerplate-stamp question. The MATRICES are reviewed instead - the owner ruled that v1's diagrams never really worked and that the matrix review replaces both the diagram and the view selection.
