...
A killer check is a step. It is dangerous to skip. It is easy to forget.

Rules:
- Keep the gated set short. Nine items or fewer.
- Word each as one checkable claim. Use the domain's own language.
