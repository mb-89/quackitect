---
description: "config / engine / binding: sets engine.binding to queue. Where the session takes its work from. The chapter The engine controls, under spec/design_output/config.md, says what each value means."
