...
func runHold(args []string) {
	...
	fs.Usage = func() {
		...
		fmt.Fprintln(os.Stdout, "")
		fmt.Fprintln(os.Stdout, "A person with no panel says it instead. A whole message that is one of")
		fmt.Fprintln(os.Stdout, "these puts everything down, and the agent has no part in it:")
		fmt.Fprintln(os.Stdout, "")
		fmt.Fprintln(os.Stdout, "  "+strings.Join(putItDown, ", "))
		fmt.Fprintln(os.Stdout, "")
		fmt.Fprintln(os.Stdout, "And one of these lets it go on:")
		fmt.Fprintln(os.Stdout, "")
		fmt.Fprintln(os.Stdout, "  "+strings.Join(pickItUp, ", "))
		fmt.Fprintln(os.Stdout, "")
		fs.PrintDefaults()
	}
	work := fs.String("work", "", "the folder being worked on (default: this one)")
