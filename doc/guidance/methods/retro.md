...
7. Read what one turn costs and the battery's lanes: `util/checks/benchmark.sh` runs both and ranks the lanes against the last run. Name what grew, then [[refactoring]]. *
