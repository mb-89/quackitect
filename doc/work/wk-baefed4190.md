...
author: reviewer-kandinsky
# the tree each time the work was taken up, snapshots the engine wrote
began:
  - cd41ecabdbcbf8258c85bfb54e47d16d87cdbc1d
# the tree each time the work was put down or closed, snapshots the engine wrote
ended:
  - 187ffb089c722a9bab27689c208624aea72381c6
# how it ended. Only an ended token carries one.
disposition: dropped
# why it was dropped
reason: "The removal never left this clone. origin/v4 always carried the preference, and worker-sibelius landed the tests.go half alone at 64de27bb, with a test of its own and engine.mjs untouched. Only the working copy here still held the deletion, so I put the two lines and their paragraph back: git diff origin/v4 -- util/checks/lib/engine.mjs is now empty. Nothing is left to restore and no pin is owed, because the tip never lost it."
---
