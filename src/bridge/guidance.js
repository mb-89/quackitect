...
function afterARestart(box) {
  ...
  // The debt stands where the layer or a compaction reached the session, because a session owes a line it read. [[spec/design_output/level0#rules-ride-the-first-answer]]
