...
//
//   node src/cage/mcp-lane.mjs --method . --work .
...
// src/cage/diagnose.mjs reads it back. The last line is where the stub got to.
...
const toolsSnapshot = join(root, "src", "cage", "tools.json");
