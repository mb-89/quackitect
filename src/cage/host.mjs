...
// and nothing in the others. So the table is src/cage/hosts.json, and this is
...
//
// WHY node AND NOT sh: see src/cage/mcp-lane.mjs.
//
//   node src/cage/host.mjs            prints the answer as JSON
//   node src/cage/host.mjs --cloud    exits 0 on a cloud box, 1 anywhere else
//   node src/cage/host.mjs --say      prints one line a person can read
