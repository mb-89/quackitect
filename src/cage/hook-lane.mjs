...
// tool lane: see src/cage/mcp-lane.mjs. One speaks JSON-RPC on a pipe that
// stays open, and this answers one event and exits.
//
//   node src/cage/hook-lane.mjs hook --method .
...
if (!existsSync(engine)) {
  ...
  process.stdout.write("quackitect: NO ENGINE IS BUILT HERE, so nothing is guarding or recording " +
    ...
    "none. If it will not come up, node src/cage/diagnose.mjs writes " +
