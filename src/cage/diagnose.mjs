...
//
// WHAT IT ASKS. Where the box is, off src/cage/hosts.json. The commit against
...
//
//   node src/cage/diagnose.mjs [--method <root>] [--work <root>]
...
out();
out("Written " + stamp + " by src/cage/diagnose.mjs.");
