...
func main() {
	flag.Parse()
	// THE SNAPSHOT THE COLD DOOR ANSWERS FROM. src/cage/mcp-lane.mjs answers
	// tools/list off src/cage/tools.json before this program is built, so a
	...
	if *toolsFlag {
		...
		_ = enc.Encode(map[string]any{
			"$comment": "GENERATED by .bin/se-mcp --tools > src/cage/tools.json. Edit src/mcp/lane.go, not this file.",
			"tools":    tools(),
		})
		return
	}
	...
	for in.Scan() {
		...
		// src/cage/mcp-lane.mjs supervises this process, watches the binary and
